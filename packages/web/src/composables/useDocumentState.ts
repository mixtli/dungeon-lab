...
import type { CreateDocumentData } from '@dungeon-lab/shared/schemas/document.schema.js';
import type { UpdateDocumentRequest } from '@dungeon-lab/shared/types/api/documents.js';
