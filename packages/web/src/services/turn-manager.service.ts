import type { ITurnManager, ITurnParticipant } from '@dungeon-lab/shared/types/index.js';
import type { BaseTurnManagerPlugin } from '@dungeon-lab/shared-ui/base/base-turn-manager.js';
import { pluginRegistry } from './plugin-registry.js';
import { useGameStateStore } from '../stores/game-state.store.js';
import type { JsonPatchOperation } from '@dungeon-lab/shared/types/index.js';
import { generateLifecycleResetPatches } from '@dungeon-lab/shared/utils/document-state-lifecycle.js';
