...
import type { GameActionRequest, ServerGameStateWithVirtuals, JsonPatchOperation } from '@dungeon-lab/shared/types/index.js';
import { 
  getHandlers, 
...
import type { ActionHandler } from '@dungeon-lab/shared-ui/types/plugin-context.js';
import { createDraft, finishDraft, enablePatches } from 'immer';
import { toRaw } from 'vue';
import { useChatStore, type ApprovalData } from '../stores/chat.store.ts';
...
import { rollRequestService } from './roll-request.service.ts';
import { createActionContext } from './action-context.service.ts';
import { getPluginContext } from '@dungeon-lab/shared-ui/utils/plugin-context.js';
import { AsyncActionContext } from '@dungeon-lab/shared-ui/types/action-context.js';
