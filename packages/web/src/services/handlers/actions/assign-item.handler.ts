...
import type { GameActionRequest, AssignItemParameters } from '@dungeon-lab/shared/types/index.js';
import type { ServerGameStateWithVirtuals, IItem } from '@dungeon-lab/shared/types/index.js';
