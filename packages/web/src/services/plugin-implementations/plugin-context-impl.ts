...
import type { RollTypeHandler } from '@dungeon-lab/shared-ui/types/plugin.js';
import type { BaseDocument, ICompendiumEntry, ActionRequestResult, GameActionType } from '@dungeon-lab/shared/types/index.js';
import type { Roll, RollRequest } from '@dungeon-lab/shared/schemas/roll.schema.js';
import { ReactivePluginStore } from '../plugin-store.js';
import { CompendiumsClient, DocumentsSocketClient } from '@dungeon-lab/client/index.js';
import { createPluginGameStateService } from '../plugin-game-state.service.js';
...
import { rollHandlerService } from '../roll-handler.service.js';
import { PlayerActionService } from '../player-action.service.js';
import { 
  registerPluginActionHandler,
  unregisterPluginActionHandler,
  unregisterAllPluginActionHandlers
} from '../multi-handler-registry.js';
import { tokenActionRegistry } from '../token-action-registry.js';
