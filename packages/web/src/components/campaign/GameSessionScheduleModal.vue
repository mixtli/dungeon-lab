            ...
            <div class="sm:flex sm:items-start">
              <div class="mt-3 text-center sm:mt-0 sm:text-left w-full">
                ...
                <div class="mt-4 space-y-4">
                  ...
                  <!-- Session Description -->
                  <div>
                    <label for="sessionDescription" class="block text-sm font-medium text-gray-700">Description (Optional)</label>
                    <textarea
                  ...
                  <div v-if="scheduleType === 'later'" class="space-y-4">
                    ...
                    <div>
                      <label for="sessionTime" class="block text-sm font-medium text-gray-700">Time</label>
                      <input
                        type="time"
                        id="sessionTime"
