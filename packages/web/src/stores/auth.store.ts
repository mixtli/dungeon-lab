...
import type { IUser, IUserPreferences } from '@dungeon-lab/shared/types/index.js';
import { AuthClient } from '@dungeon-lab/client/auth.client.js';
import { LoginRequest, RegisterRequest } from '@dungeon-lab/shared/types/api/authentication.js';
