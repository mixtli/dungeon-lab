...
import { useSocketStore } from './socket.store.ts';
import { Socket } from 'socket.io-client';
import type {
  ServerToClientEvents,
  ClientToServerEvents
} from '@dungeon-lab/shared/types/socket/index.js';
import { useGameSessionStore } from './game-session.store.ts';
import { useGameStateStore } from './game-state.store.js';
import { useAuthStore } from './auth.store.ts';
import type { ParsedMessage, Mention } from '@dungeon-lab/shared/types/chat.js';
import type { RollServerResult, RollRequest } from '@dungeon-lab/shared/schemas/roll.schema.js';
import type { GameActionRequest } from '@dungeon-lab/shared/types/game-actions.js';
import type { RollResultData } from '@dungeon-lab/shared-ui/types/action-context.js';
