...
import { Campaign, CreateCampaignDto, UpdateCampaignDto } from '@dungeon-lab/shared';
...
export const useCampaignStore = defineStore('campaign', () => {
  ...
  async function createCampaign(campaignData: CreateCampaignDto) {
    loading.value = true;
    error.value = null;
  ...
  async function updateCampaign(id: string, campaignData: UpdateCampaignDto) {
    loading.value = true;
    error.value = null;
