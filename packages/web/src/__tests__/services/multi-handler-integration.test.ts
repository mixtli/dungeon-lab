...
import type { ActionHandler, ActionValidationResult, PluginContext } from '@dungeon-lab/shared-ui/types/plugin-context.js';
import type { RollServerResult } from '@dungeon-lab/shared/schemas/roll.schema.js';
import { registerAction, getHandlers, clearAllHandlers } from '../../services/multi-handler-registry.js';
import { produceGameStateChanges } from '../../services/immer-utils.js';
import type { GameActionRequest, ServerGameStateWithVirtuals } from '@dungeon-lab/shared/types/index.js';
