...
import { endTurnActionHandler } from '../../services/handlers/actions/end-turn.handler.js';
import { stopEncounterActionHandler } from '../../services/handlers/actions/stop-encounter.handler.js';
import { registerPluginStateLifecycle, clearAllPluginStateLifecycles } from '@dungeon-lab/shared/utils/document-state-lifecycle.js';

// Mock stores to avoid Vue dependencies in tests
vi.mock('../../../stores/game-session.store.js', () => ({
