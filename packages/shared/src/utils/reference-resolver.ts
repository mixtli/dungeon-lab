...
import type { ICompendiumEntry } from '../types/index.js';
import type { ReferenceOrObjectId } from '../types/reference.js';
import { isResolvedObjectId, isReferenceObject } from '../types/reference.js';
