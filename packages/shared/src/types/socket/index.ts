import { z } from 'zod';
import * as socketTypes from '../../schemas/socket/index.js';
import * as encounterSocketSchemas from '../../schemas/socket/encounters.js';
import * as documentSocketSchemas from '../../schemas/socket/documents.js';
...
// Roll types using new roll system
export type Roll = z.infer<typeof socketTypes.rollSchema>;
export type RollServerResult = z.infer<typeof socketTypes.rollServerResultSchema>;
