import { z } from 'zod';
import { gameSessionSchema, gameSessionCreateSchema } from '../../schemas/game-session.schema.js';
import { baseAPIResponseSchema } from './base.js';
import type { IGameSession } from '../index.js';
