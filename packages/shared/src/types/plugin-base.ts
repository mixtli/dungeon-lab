...
import type { PluginContextBase } from './plugin-context-base.js';

// Export the base class for plugins to extend
export { BaseGameSystemPluginBase } from '../base/base-plugin-base.js';

// Re-export types for convenience
export type { PluginContextBase } from './plugin-context-base.js';
export type { PluginManifest } from '../schemas/plugin-manifest.schema.js';
