...
import type { IMessage } from '@dungeon-lab/shared';
import { Request } from 'express';
import { handleChatMessage } from './handlers/chat-handler.js';
import { handleDiceRoll } from './handlers/dice-handler.js';
import { handlePluginAction } from './handlers/plugin-handler.js';
import { handleGameStateUpdate } from './handlers/game-state-handler.js';
