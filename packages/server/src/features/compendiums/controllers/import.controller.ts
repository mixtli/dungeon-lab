...
import { CompendiumModel } from '../models/compendium.model.js';
import { COMPENDIUM_IMPORT_JOB, getImportProgress } from '../jobs/compendium-import.job.js';
import { uploadBuffer } from '../../../services/storage.service.js';
import { transactionService } from '../../../services/transaction.service.js';
import { BaseAPIResponse } from '@dungeon-lab/shared/types/api/base.js';
import { CompendiumManifest, ImportProgress, ValidationResult } from '@dungeon-lab/shared/schemas/import.schema.js';
...
export class ImportController {
  ...
  deleteCompendium = asyncHandler(async (req: Request, res: Response<BaseAPIResponse<{ message: string }>>) => {
    try {
      ...
      const { CompendiumModel } = await import('../models/compendium.model.js');
