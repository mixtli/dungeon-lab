...
import { CompendiumReferenceResolver } from '@dungeon-lab/shared/services/compendium-reference-resolver.js';
...
export class ServerCompendiumReferenceResolutionService {
  ...
  async resolveEntryReferences(entryId: string, compendiumId: string): Promise<{
    ...
    const { buildCompendiumIndex } = await import('@dungeon-lab/shared/services/reference-resolution.js');
