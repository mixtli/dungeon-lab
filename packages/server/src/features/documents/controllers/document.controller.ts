...
import { DocumentService, QueryValue } from '../services/document.service.js';
...
} from '@dungeon-lab/shared/types/api/index.js';
import { 
  characterCreateSchema,
  actorCreateSchema,
  itemCreateSchema,
  vttDocumentCreateSchema
} from '@dungeon-lab/shared/schemas/index.js';
import { BaseDocument } from '@dungeon-lab/shared/types/index.js';
import { ZodError } from 'zod';
import { createSearchParams } from '../../../utils/create.search.params.js';
import { isErrorWithMessage } from '../../../utils/error.js';
...
export class DocumentController {
  ...
  generateDocumentToken = async (
    ...
    try {
      ...
      const { backgroundJobService } = await import('../../../services/background-job.service.js');
      const { DOCUMENT_IMAGE_GENERATION_JOB } = await import('../jobs/document-image.job.js');
