...
import type { ICharacter, IActor, IItem, IEncounter } from '@dungeon-lab/shared/types/index.js';
import type { z } from 'zod';
import { campaignSchema } from '@dungeon-lab/shared/schemas/campaign.schema.js';

// Import backing models
import { CharacterDocumentModel } from '../../documents/models/character-document.model.js';
import { ActorDocumentModel } from '../../documents/models/actor-document.model.js';
import { ItemDocumentModel } from '../../documents/models/item-document.model.js';
import { EncounterModel } from '../../encounters/models/encounter.model.js';
...
export class GameStateSyncService {
  ...
  async syncGameStateToBackingModels(
    ...
    try {
      ...
      const { GameStateService } = await import('./game-state.service.js');
