...
import { getFileUrl, getPublicUrl, uploadFile, deleteFile } from './storage.service.mjs';
...
type AssetDocument = mongoose.Document<unknown, object, IAssetModel> & IAssetModel & {
