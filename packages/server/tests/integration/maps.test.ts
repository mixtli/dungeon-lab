...
vi.mock('../../src/features/maps/utils/map-image-generator.ts', () => ({
...
vi.mock('../../src/utils/image-generator.ts', () => ({
...
vi.mock('../../src/features/maps/services/map.service.ts', () => {
...
import { getTestAgent } from '../test-utils.js';
import { requestAs, clearAuthCache } from '../utils/auth-test-helpers.js';
import { TEST_USERS, createTestUsers, cleanupTestUsers } from '../utils/testUsers.js';
import type { UploadedAsset } from '../../src/utils/asset-upload.utils.js';
...
vi.mock('../../src/features/campaigns/services/campaign.service.ts', () => {
  return {
