...
import { convertSpell, uploadSpellImage } from './convert-5etools-spell.js';
import { itemDataSchema } from '../shared/types/item.js';
import config from '../../manifest.json' with { type: 'json' };
import { configureApiClient, ItemsClient } from '@dungeon-lab/client/index.js';
