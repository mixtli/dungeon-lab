...
} from './convert-5etools-class.js';
import type { ICharacterClassData } from '../shared/types/character-class.js';
import { toLowercase } from './converter-utils.js';
import { join, dirname } from 'path';
import { fileURLToPath } from 'url';
import { DocumentsClient, configureApiClient } from '@dungeon-lab/client/index.js';
