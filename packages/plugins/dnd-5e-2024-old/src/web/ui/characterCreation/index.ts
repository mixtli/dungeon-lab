...
import { PluginComponent } from '@dungeon-lab/shared/base/plugin-component.js';
import { IPluginAPI } from '@dungeon-lab/shared/types/plugin-api.js';
import { z } from 'zod';
/**
...
import { registerHelpers } from '../../../web/helpers/handlebars.js';
import { CharacterCreationFormData, PartialCharacterCreationFormData } from './formSchema.js';

// Import document helpers
import { registerDocumentHelpers } from '../../helpers/document-helpers.js';

// Import shared types from the plugin
import { ICharacterClassDocument } from '../../../shared/types/character-class.js';
import { IBackgroundDocument, ISpeciesDocument } from '../../../shared/types/vttdocument.js';

// Import the document cache service
import { getClass, getDocumentById } from '../../document-cache.js';
import {merge} from 'ts-deepmerge'

// Import the flat package for unflattening form data
import { unflatten } from 'flat';
// Import our form schema
import { characterCreationFormSchema } from './formSchema.js';

import { ICharacterData } from '../../../shared/types/character.js';
