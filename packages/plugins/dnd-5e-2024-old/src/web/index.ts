import { IGameSystemPluginWeb, IPluginAPI } from '@dungeon-lab/shared/types/plugin.js';
import { WebPlugin } from '@dungeon-lab/shared/base/web.js';
...
import { initializeCache, preloadAllDocuments } from './document-cache.js';

// Import components
import CharacterCreationComponent from './ui/characterCreation/index.js';
import CharacterSheetComponent from './ui/characterSheet/index.js';
