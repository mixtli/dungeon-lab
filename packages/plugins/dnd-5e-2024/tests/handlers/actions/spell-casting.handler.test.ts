...
import type { AsyncActionContext } from '@dungeon-lab/shared/interfaces/action-context.interface.js';
import type { PluginContext } from '@dungeon-lab/shared-ui/types/plugin-context.js';
import type { DndSpellDocument } from '../../../src/types/dnd/spell.js';
import type { DndCharacterData } from '../../../src/types/dnd/character.js';
import { executeSpellCast } from '../../../src/handlers/actions/spell-casting.handler.js';
...
vi.mock('../../../src/services/spell-lookup.service.js', () => ({
  lookupSpell: vi.fn(),
...
import {
  ...
  getSpellDamage,
  getSpellSavingThrow
} from '../../../src/services/spell-lookup.service.js';
