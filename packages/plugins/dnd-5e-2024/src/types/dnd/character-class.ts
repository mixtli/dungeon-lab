import { z } from 'zod';
import { vttDocumentSchema } from '@dungeon-lab/shared/schemas/index.js';
import { abilitySchema, restTypeSchema, spellcastingAbilitySchema, spellcastingTypeSchema, spellPreparationSchema, spellReferenceObjectSchema, itemReferenceObjectSchema, proficiencyEntrySchema, armorProficiencySchema } from './common.js';
