...
import type { GameActionRequest, ServerGameStateWithVirtuals, ICharacter, IActor, IItem } from '@dungeon-lab/shared/types/index.js';
import type { AsyncActionContext } from '@dungeon-lab/shared-ui/types/action-context.js';
import type { ActionValidationResult, ActionValidationHandler, ActionExecutionHandler, ActionHandler } from '@dungeon-lab/shared-ui/types/plugin-context.js';
import { 
  validateActionEconomy, 
  consumeAction
} from '../../utils/action-economy.js';
import { parseDiceExpression } from '@dungeon-lab/shared/utils/dice-parser.js';
import { calculateGridDistance } from '@dungeon-lab/shared-ui/utils/grid-distance.js';
import { calculateD20Total, isCriticalHit, isCriticalFailure } from '../../utils/dnd-roll-utilities.js';
import type { DndItemDocument, DndWeaponData } from '../../types/dnd/item.js';
