...
import type { GameActionRequest, ServerGameStateWithVirtuals, ICharacter } from '@dungeon-lab/shared/types/index.js';
...
import type { UnequipItemParameters } from '../../shared/types/equipment-actions.js';
