...
export function init(
  ...
  // Note: Helpers are now registered by the plugin class before template rendering
  
  let formControls: FormControls = { cleanup: () => {} };
 ...
 */
export function validateCharacter(characterData: Record<string, any>): ValidationResult {
