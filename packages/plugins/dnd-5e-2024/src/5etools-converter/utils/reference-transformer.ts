 ...
 */
import { ReferenceObject, DocumentReference } from '@dungeon-lab/shared/types/index.js';
import { documentTypeSchema } from '@dungeon-lab/shared/schemas/index.js';
import { ParsedReference, TextReferenceMatch, scanTextForReferences } from './reference-parser.js';
import type { EtoolsEntry } from '../../5etools-types/base.js';
import type { EtoolsMonsterSpellcasting } from '../../5etools-types/monsters.js';
import type { MonsterSpellcasting, SpellReferenceObject } from '../../types/dnd/common.js';
