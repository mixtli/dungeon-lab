...
import type { EtoolsItem } from '../../5etools-types/items.js';
...
import { 
  ...
  type DndGearData,
  type DndToolData
} from '../../types/dnd/item.js';
import { expandWeaponProperty, damageTypeSchema, type DamageType } from '../../types/dnd/common.js';
