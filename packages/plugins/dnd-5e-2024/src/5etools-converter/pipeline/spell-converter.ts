...
import { 
  ...
  entriesToCleanText 
} from '../text/markup-processor.js';
import type { 
  EtoolsSpell, 
  EtoolsSpellData
} from '../../5etools-types/spells.js';
import type { EtoolsEntry } from '../../5etools-types/base.js';
import { dndSpellDataSchema, type DndSpellData } from '../../types/dnd/spell.js';
import { extractEtoolsArray, safeEtoolsCast } from '../../5etools-types/type-utils.js';
import type { Ability, DamageType } from '../../types/dnd/common.js';
