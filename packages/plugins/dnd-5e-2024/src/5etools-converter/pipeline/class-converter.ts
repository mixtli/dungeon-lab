...
import { z } from 'zod';
import { TypedConverter } from './converter.js';
import { 
  type ClassDocument,
  type DocumentType,
  type PluginDocumentType
} from '../validation/document-validators.js';
import { processEntries, cleanMarkupText } from '../text/markup-processor.js';
import { etoolsItemSchema } from '../../5etools-types/items.js';
import type { EtoolsClassData, EtoolsClassFluff, EtoolsClassFluffData, EtoolsSubclass } from '../../5etools-types/classes.js';
...
import { etoolsClassSchema } from '../../5etools-types/classes.js';
import { 
  dndCharacterClassDataSchema, 
  type DndCharacterClassData
} from '../../types/dnd/character-class.js';
import { ABILITY_ABBREVIATION_MAP, expandSpellcastingAbility, spellReferenceObjectSchema, type SpellReferenceObject, SKILLS_2024, type ProficiencyEntry, type ProficiencyFilterConstraint } from '../../types/dnd/common.js';
import { safeEtoolsCast } from '../../5etools-types/type-utils.js';
