...
import type { EtoolsMonsterData } from '../../5etools-types/monsters.js';
import { etoolsMonsterSchema } from '../../5etools-types/monsters.js';
import type { EtoolsEntry } from '../../5etools-types/base.js';
import { 
  dndCreatureDataSchema, 
  type DndCreatureData
} from '../../types/dnd/creature.js';
import { safeEtoolsCast } from '../../5etools-types/type-utils.js';
import { damageTypeSchema, type DamageType, type SpellReferenceObject } from '../../types/dnd/common.js';
import { parseActionMarkup } from '../utils/markup-parser.js';
