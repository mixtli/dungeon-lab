 ...
 */
function rollInitiative(req, res) {
    try {
        const { dexterityModifier, advantage, disadvantage, bonuses = 0 } = req.body;
        // Validate input
 ...
 */
export function createInitiativeRouter() {
    const router = Router();
...
//# sourceMappingURL=initiative-route.mjs.map